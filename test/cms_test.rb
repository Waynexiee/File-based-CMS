...
class AppTest < Minitest::Test
  ...
  def test_viewing_text_document
    create_document "history.txt", "1996 - Ruby 1.0 released."
    get "/history.txt"
    assert_equal 200, last_response.status
  ...
  def test_not_found_file
    ...
    assert_equal "The specified file was not found.", session[:message]
  end
  ...
  def test_editting_document
    create_document "changes.txt"
    get "/changes.txt/edit", {}, admin_session

    assert_equal 200, last_response.status
    assert_includes last_response.body, %q(<textarea name="content" id="content" rows="20" cols="100">)
  ...
  def test_sign_in_with_bad_credential
    post "/users/signin", username: "adin", password: "secrt"
